...
@Component({
  selector: 'app-confirm-addday-confirm',
  templateUrl: './confirm-addday-confirm.page.html',
  styleUrls: ['./confirm-addday-confirm.page.scss'],
})
export class ConfirmAdddayConfirmPage implements OnInit {
      ...
      buttons: [
        {
          ...
          text: confirm,
          handler: () => {
            this.webService.postData({ cp_id: this.data.cp_id, status: 1 }, 'payments/change_payment_day').then((result: any) => {
              if (result - 0 == 1) {
      ...
      buttons: [
        {
          ...
          text: cancel,
          handler: () => {
            this.webService.postData({ cp_id: this.data.cp_id, status: 2 }, 'payments/change_payment_day').then((result: any) => {
              if (result - 0 == 1) {
